...
function switcherClick() {
    let ltrBtn, rtlBtn, verticalBtn,
        horiBtn, lightBtn, darkBtn, boxedBtn,
        fullwidthBtn,
        scrollMenuBtn,
        fixedMenuBtn,
        scrollHeaderBtn,
        ...
        defaultTransparentHeaderBtn, regular,
        classic, defaultBtn, closedBtn,
        iconTextBtn,
        detachedBtn,
        overlayBtn,
        doubleBtn,
        ...
        menuClickBtn,
        menuHoverBtn,
        iconClickBtn, iconHoverBtn,
        primaryDefaultColor1Btn,
        primaryDefaultColor2Btn, primaryDefaultColor3Btn, primaryDefaultColor4Btn, primaryDefaultColor5Btn, bgDefaultColor1Btn, bgDefaultColor2Btn, bgDefaultColor3Btn, bgDefaultColor4Btn, bgDefaultColor5Btn, bgImage1Btn, bgImage2Btn, bgImage3Btn, bgImage4Btn, bgImage5Btn, ResetAll, loaderEnable, loaderDisable;
    let html = document.querySelector("html");
    ...
    defaultLightHeaderBtn = document.querySelector(
        "#switcher-default-header-light"
    );
    defaultDarkHeaderBtn = document.querySelector(
        "#switcher-default-header-dark"
    );
    defaultColorHeaderBtn = document.querySelector(
        "#switcher-default-header-primary"
    );
    defaultGradientHeaderBtn = document.querySelector(
        "#switcher-default-header-gradient"
    );
    defaultTransparentHeaderBtn = document.querySelector(
        "#switcher-default-header-transparent"
    );
    ...
    let backgroundColor1Var = bgDefaultColor1Btn?.addEventListener("click", () => {
        ...
        html.style.setProperty("--body-bg-rgb2", localStorage.bodyBgRGB2);
    ...
    let lightThemeVar = lightBtn?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziraMenu", "light");
    ...
    let colorHeaderVar = colorHeaderBtn?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziraHeader", "color");
        html.removeAttribute("data-default-header-styles");
    });
    /* Color Header End */
    ...
    let darkHeaderVar = darkHeaderBtn?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziraHeader", "dark");
        html.removeAttribute("data-default-header-styles");
    });
    /* Dark Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn?.addEventListener(
        ...
        () => {
            ...
            localStorage.setItem("aziraHeader", "transparent");
            html.removeAttribute("data-default-header-styles");
        }
    );
    ...
    let defaultLightHeaderVar = defaultLightHeaderBtn?.addEventListener(
        "click",
        () => {
            html.setAttribute("data-default-header-styles", "light");
            html.removeAttribute("data-header-styles");
            localStorage.setItem("aziraDefaultHeader", "light");
        }
    );
    /* Default Light Header End */

    /* Default Color Header Start */
    let defaultColorHeaderVar = defaultColorHeaderBtn?.addEventListener(
        "click",
        () => {
            html.setAttribute("data-default-header-styles", "color");
            html.removeAttribute("data-header-styles");
            localStorage.setItem("aziraDefaultHeader", "color");
        }
    );
    /* Default Color Header End */

    /* Default Dark Header Start */
    let defaultDarkHeaderVar = defaultDarkHeaderBtn?.addEventListener(
        "click",
        () => {
            html.setAttribute("data-default-header-styles", "dark");
            html.removeAttribute("data-header-styles");
            localStorage.setItem("aziraDefaultHeader", "dark");
        }
    );
    /* Default Dark Header End */

    /* Default sGradient Header Start */
    let defaultGradientHeaderVar = defaultGradientHeaderBtn?.addEventListener(
        "click",
        () => {
            html.setAttribute("data-default-header-styles", "gradient");
            html.removeAttribute("data-header-styles");
            localStorage.setItem("aziraDefaultHeader", "gradient");
        }
    );
    /* Default Gradient Header End */

    /* Default Transparent Header Start */
    let defaultTransparentHeaderVar =
        defaultTransparentHeaderBtn?.addEventListener("click", () => {
            html.setAttribute("data-default-header-styles", "transparent");
            html.removeAttribute("data-header-styles");
            localStorage.setItem("aziraDefaultHeader", "transparent");
        });
    ...
    let fullwidthVar = fullwidthBtn?.addEventListener("click", () => {
        ...
        localStorage.setItem("azirafullwidth", true);
        localStorage.removeItem("aziraboxed");
    });
    ...
    let boxedVar = boxedBtn?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziraboxed", true);
        localStorage.removeItem("aziraheaderrounded");
        localStorage.removeItem("azirafullwidth");
        setTimeout(() => {
            checkHoriMenu();
        }, 100);
    });
    ...
    let shadowVar = regular?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziraregular", true);
        localStorage.removeItem("aziraclassic");
    });
    ...
    let noShadowVar = classic?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziraclassic", true);
        localStorage.removeItem("aziraregular");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziraheaderfixed", true);
        localStorage.removeItem("aziraheaderscrollable");
        localStorage.removeItem("aziraheaderrounded");
    });

    let scrollHeaderVar = scrollHeaderBtn?.addEventListener("click", () => {
        html.setAttribute("data-header-position", "scrollable");
        localStorage.setItem("aziraheaderscrollable", true);
        localStorage.removeItem("aziraheaderfixed");
        localStorage.removeItem("aziraheaderrounded");
    });
    ...
    let fixedMenuVar = fixedMenuBtn?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziramenufixed", true);
        localStorage.removeItem("aziramenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn?.addEventListener("click", () => {
        html.setAttribute("data-menu-position", "scrollable");
        localStorage.setItem("aziramenuscrollable", true);
        localStorage.removeItem("aziramenufixed");
    });
    ...
    let menuClickVar = menuClickBtn?.addEventListener("click", () => {
        ...
        menuClickFn();
        localStorage.setItem("aziranavstyles", "menu-click");
        localStorage.removeItem("aziraverticalstyles");
        document.querySelectorAll(".main-menu>li.open").forEach((ele) => {
            if (!ele.classList.contains("active")) {
                ele.classList.remove("open");
    ...
    let menuhoverVar = menuHoverBtn?.addEventListener("click", () => {
        html.removeAttribute("data-vertical-style");
        menuhoverFn();
        localStorage.setItem("aziranavstyles", "menu-hover");
        localStorage.removeItem("aziraverticalstyles");
        document.querySelectorAll(".main-menu>li.open").forEach((ele) => {
            if (!ele.classList.contains("active")) {
                ele.classList.remove("open");
    ...
    let iconClickVar = iconClickBtn?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziranavstyles", "icon-click");
        localStorage.removeItem("aziraverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn?.addEventListener("click", () => {
        ...
        localStorage.setItem("aziranavstyles", "icon-hover");
        localStorage.removeItem("aziraverticalstyles");
    ...
    let verticalVar = verticalBtn?.addEventListener("click", () => {
        ...
        // local storage
        localStorage.removeItem("aziralayout");
    ...
    let horiVar = horiBtn?.addEventListener("click", () => {
        ...
        html.removeAttribute("data-vertical-style");
        //    local storage
        localStorage.setItem("aziralayout", "horizontal");
        localStorage.removeItem("aziraverticalstyles");
    ...
    /* loader start */
    loaderEnable?.addEventListener("click", () => {
        document.querySelector("html").setAttribute("loader", "enable");
        localStorage.setItem("loaderEnable", "true");
    });

    loaderDisable?.addEventListener("click", () => {
...
function lightFn() {
    ...
    localStorage.removeItem("aziraheaderbg");
    localStorage.removeItem("azirabgwhite");
    localStorage.removeItem("aziramenubg");
    localStorage.removeItem("aziraDefaultHeader");
    checkOptions();
...
function checkOptions() {
    ...
    //RTL
    if (localStorage.getItem("azirartl")) {
    ...
    // color header
    if (localStorage.getItem("aziraHeader") === "color") {
        document.querySelector("#switcher-header-primary").checked = true;
    }

    // gradient header
    if (localStorage.getItem("aziraHeader") === "gradient") {
        document.querySelector("#switcher-header-gradient").checked = true;
    }

    // dark header
    if (localStorage.getItem("aziraHeader") === "dark") {
        document.querySelector("#switcher-header-dark").checked = true;
    }
    // transparent header
    if (localStorage.getItem("aziraHeader") === "transparent") {
        document.querySelector("#switcher-header-transparent").checked = true;
    }

    // light header
    if (localStorage.getItem("aziraDefaultHeader") === "light") {
        document.querySelector("#switcher-default-header-light").checked = true;
    }

    // color header
    if (localStorage.getItem("aziraDefaultHeader") === "color") {
        document.querySelector("#switcher-default-header-primary").checked = true;
    }

    // gradient header
    if (localStorage.getItem("aziraDefaultHeader") === "gradient") {
        document.querySelector("#switcher-default-header-gradient").checked = true;
    }

    // dark header
    if (localStorage.getItem("aziraDefaultHeader") === "dark") {
        document.querySelector("#switcher-default-header-dark").checked = true;
    }
    // transparent header
    if (localStorage.getItem("aziraDefaultHeader") === "transparent") {
    ...
    // light menu
    if (localStorage.getItem("aziraMenu") === "light") {
        document.querySelector("#switcher-menu-light").checked = true;
    }

    // dark menu
    if (localStorage.getItem("aziraMenu") === "dark") {
        document.querySelector("#switcher-menu-dark").checked = true;
    }

    //boxed
    if (localStorage.getItem("aziraboxed")) {
        document.querySelector("#switcher-boxed").checked = true;
    }

    //scrollable
    if (localStorage.getItem("aziraheaderscrollable")) {
        document.querySelector("#switcher-header-scroll").checked = true;
    }
    if (localStorage.getItem("aziramenuscrollable")) {
        document.querySelector("#switcher-menu-scroll").checked = true;
    }

    //fixed
    if (localStorage.getItem("aziraheaderfixed")) {
        document.querySelector("#switcher-header-fixed").checked = true;
    }
    if (localStorage.getItem("aziraheaderscrollable")) {
        document.querySelector("#switcher-header-scroll").checked = true;
    }
    if (localStorage.getItem("aziraheaderrounded")) {
        document.querySelector("#switcher-header-rounded").checked = true;
    }

    //classic
    if (localStorage.getItem("aziraclassic")) {
...
function updateColors() {
    ...
    if (document.querySelector("#communitygrowth") !== null) {
        communitygrowth();
    }
    if (document.querySelector("#projectworkloadchart") !== null) {
        projectworkloadchart();
    }

    if (document.querySelector("#trendingchart") !== null) {
        trendingBusinessChart();
    }
    //trendingBusinessChart
    if (document.querySelector("#externalchart") !== null) {
        externalchart();
    }
}
updateColors();
